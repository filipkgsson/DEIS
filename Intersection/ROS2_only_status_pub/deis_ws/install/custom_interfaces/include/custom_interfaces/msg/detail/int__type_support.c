...
#include <stddef.h>
#include "custom_interfaces/msg/detail/int__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interfaces__msg__Int__init(message_memory);
}

void Int__rosidl_typesupport_introspection_c__Int_fini_function(void * message_memory)
{
  custom_interfaces__msg__Int__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Int__rosidl_typesupport_introspection_c__Int_message_member_array[1] = {
  {
    "data",  // name
    ...
    offsetof(custom_interfaces__msg__Int, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Int__rosidl_typesupport_introspection_c__Int_message_members = {
  ...
  "Int",  // message name
  1,  // number of fields
  sizeof(custom_interfaces__msg__Int),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, Int)() {
